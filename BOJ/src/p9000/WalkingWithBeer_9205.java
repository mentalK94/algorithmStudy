/**
 * Backjoon - 9205. 맥주마시며 걸어가기
 * WalkingWithBeer_9205.java
 * @date 2020-09-26
 * @author hansolKim
 **/
...
public class WalkingWithBeer_9205 {
    ...
    public static void main(String[] args) throws NumberFormatException, IOException {
        ...
        ArrayList<PointXY> a; // 집, 편의점, 페스티벌에 위치를 저장하는 배열
    ...
    // 맨해튼 거리
    public static int Manhattan(PointXY p1, PointXY p2) {
